...
<c:set var="firstName" value="${ admin.firstName }" />
<c:set var="lastName" value="${ admin.lastName }" />
<c:set var="email" value="${ admin.email }" />
<c:set var="contactNo" value="${ admin.contactNo }" />
...
<form action='<c:url value="/admin/edit/profile" />' method="post">
