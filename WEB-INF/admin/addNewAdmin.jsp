...
<c:if test="${ not empty addNewAdminStatus }">
    <c:choose>
        <c:when test='${ addNewAdminStatus eq "success" }'>
            <div class="alert alert-success offset-4 col-4">Admin has been added.</div>
        </c:when>
        <c:when test='${ addNewAdminStatus eq "failure" }'>
...
<form action='<c:url value="/admin/add/new/admin" />' method="post">
    <fieldset class="form-group">
        <legend class="text-center text-success">Add New Admin</legend>
        ...
        <div class="form-group row">
            <div class="offset-4 col-4">
                <input class="btn btn-block btn-outline-success" type="submit" name="submit" value="Add New Admin">
            </div>
        </div>
    </fieldset>
</form>
